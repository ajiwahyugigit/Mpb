...
use App\Http\Requests\Admin\PengirimanBerasilRequest;
use App\PengirimanBerasil;
use App\StatusPengiriman;
use Illuminate\Http\Request;
use Illuminate\Support\str;
use Illuminate\Support\Facades\DB;

class PengirimanBerasilController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('pages.admin.pengiriman-berasil.index', [
            'items' => $items
        ]);
    }
